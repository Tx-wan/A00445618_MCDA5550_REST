...
import com.twan.framework.entity.GenderConvertor;
...
public class ReservationController {
	...
	public String createReservation(@RequestBody String newReservationJSON) 
			throws JacksonException , ResourceNotFoundException, HotelNotAvailableException, ParseException{		
		...
		for (int i=0;i< gNode.size(); i ++) {
			...
			guest.setLastName(guestLasttName);
			guest.setGender(guestGender);
